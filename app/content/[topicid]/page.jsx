...
export default async function Home({params}) {
    let callingContent = await fetch(`http://127.0.0.1:3000/api/content/${params.topicid}`)
    callingContent = await callingContent.json()

    let callingTopic = await fetch(`http:127.0.0.1:3000/api/topic/${params.topicid}`)
    ...
    <div className="flex">
      ...
      <div className="w-10/12">
        ...
        <div className="flex mt-5">
            <h2 className="text-lg font-semibold">All {callingTopic.data.topic_title} Contents</h2>
        </div>
